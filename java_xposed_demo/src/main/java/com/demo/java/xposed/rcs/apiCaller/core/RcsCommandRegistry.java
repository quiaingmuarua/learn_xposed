...
//        CommandRouter.register(XpGrpcMethodEnum.AUTO_KICK_DELIVERED_USERS.getPath(), (channelRequestParams,commandContext) ->
//               InnerHandlerManager.handleAutoKickDeliverGroupUsers(CachedGroupInfo.getDeliveredGroupMembersMap(), classLoader));
//        CommandRouter.register(XpGrpcMethodEnum.AUTO_KICK_SENT_USERS.getPath(), (channelRequestParams,commandContext) ->
